...
#------------------------------------------------------------------
		...
		plt.ylabel('IAF Density', fontsize=ftsz)
		plt.yscale('log') 
		ax = plt.gca()
		...
		elif sheetname == 'Not in use':
			ax.set_ylim([1000,100000000000])
		...
		plt.savefig(f"E:/NSA_329/33_14/ExINP{sheetname}_INP_SA_{hravg}Havg_{time1}-{time2}.png")
		# plt.show()